...
import com.movie_recommendation.movie_recommendation.entity.Hollywood;
...
@Repository
public interface HollyRepository extends JpaRepository<Hollywood, Integer> {

    @Query("""
        SELECT m FROM Hollywood m
    ...
    """)
    List<Hollywood> findMoviesByFilters(
