...
import com.movie_recommendation.movie_recommendation.entity.Bollywood;
...
@Repository
public interface BollyRepository extends JpaRepository<Bollywood, Integer> {

    @Query("""
        SELECT m FROM Bollywood m
    ...
    """)
    List<Bollywood> findMoviesByFilters(
