...
import com.movie_recommendation.movie_recommendation.entity.Mollywood;
...
@Repository
public interface MollyRepository extends JpaRepository<Mollywood, Integer> {

    @Query("""
        SELECT m FROM Mollywood m
    ...
    """)
    List<Mollywood> findMoviesByFilters(
